...
public class MenuNhanVien implements LamViec {
    ...
    public void Nhanvien(Database db, NhanVien nv) {
        this.db = db;
        this.nv = nv;
    }
 ...
 * 4. Tao hoa don mua hang cho khach(Lấy sdt , check mã giảm giá , nếu chưa có
 * thì tạo mới)
 * 5. Doi / Tra Hàng
 * 6. Tim Kiem San Pham
 ...
 * 12. Bảo hành sản phẩm (xem các đơn bảo hành đang nhận , tạo và lưu phiếu bảo
 * hành)
 * 0. Thoat
 */